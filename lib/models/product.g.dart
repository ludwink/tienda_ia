...
int _productEstimateSize(
  ...
  bytesCount += 3 + object.sizes.length * 3;
  {
    for (var i = 0; i < object.sizes.length; i++) {
      final value = object.sizes[i];
      bytesCount += value.length * 3;
    }
  }
...
void _productSerialize(
  ...
  writer.writeStringList(offsets[5], object.sizes);
...
Product _productDeserialize(
  ...
  final object = Product(
    ...
    sizes: reader.readStringList(offsets[5]) ?? [],
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> isarIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> isarIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
